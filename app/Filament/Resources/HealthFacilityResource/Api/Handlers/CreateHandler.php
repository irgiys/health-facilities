...
use App\Filament\Resources\HealthFacilityResource\Api\Requests\CreateHealthFacilityRequest;
...
class CreateHandler extends Handlers {
     ...
     *
     * @param CreateHealthFacilityRequest $request
     * @return \Illuminate\Http\JsonResponse
     */
    public function handler(CreateHealthFacilityRequest $request)
    {
