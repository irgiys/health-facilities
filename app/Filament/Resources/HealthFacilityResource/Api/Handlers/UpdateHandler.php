...
use App\Filament\Resources\HealthFacilityResource\Api\Requests\UpdateHealthFacilityRequest;
...
class UpdateHandler extends Handlers {
     ...
     *
     * @param UpdateHealthFacilityRequest $request
     * @return \Illuminate\Http\JsonResponse
     */
    public function handler(UpdateHealthFacilityRequest $request)
    {
        $id = $request->route('id');
